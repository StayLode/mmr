...
//Path
const char* p_image = "./image.jpg";
const char* p_mesh = "./mesh.ply";
const char* p_out_yaml = "./cokkies_ORB.yaml";

// Boolean the know if the registration it's done
bool end_registration = false;

// Intrinsic camera parameters: UVC WEBCAM
const double f = 48; // focal length in mm
const double sx = 0, sy = 0;
const double width = 1280, height = 720;
const double params_CANON[] = { 906.789900045893,   // fx
                                914.235393453131,  // fy
                                652.531687107407,      // cx
                                348.016355255329};    // cy
...
int main(int argc, char *argv[])
{
    ...
    string img_path = p_image;           // image to register
    string ply_read_path = p_mesh;       // object mesh
    string write_path = p_out_yaml;      // output file
